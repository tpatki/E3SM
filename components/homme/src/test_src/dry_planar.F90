...
subroutine hgw_init(elem,hybrid,hvcoord,nets,nete)
  ...
  call general_gw_init(elem,hybrid,hvcoord,nets,nete,100.0D0 * 1000.0D0, 0.0D0) ! EVENTUALLY ALLOW A CONSTATNT CORIOLIS FORCE HERE...

end subroutine hgw_init

! planar nonhydrostatic gravity wave
subroutine nhgw_init(elem,hybrid,hvcoord,nets,nete)
  ...
  call general_gw_init(elem,hybrid,hvcoord,nets,nete,5.0D0 * 1000.0D0, 0.0D0)

end subroutine nhgw_init



subroutine general_gw_init(elem,hybrid,hvcoord,nets,nete,d,f)
  ...
  if (hybrid%masterthread) write(iulog,*) 'initializing planar nonhydrostatic gravity wave'
...
end subroutine general_gw_init

! planar hydrostatic mountain wave
subroutine hmw_init(elem,hybrid,hvcoord,nets,nete)
...
end subroutine hmw_init

! planar nonhydrostatic mountain wave
subroutine nhmw_init(elem,hybrid,hvcoord,nets,nete)
...
end subroutine nhmw_init

! planar Schar mountain wave
subroutine smw_init(elem,hybrid,hvcoord,nets,nete)
...
end subroutine smw_init


! planar density current
subroutine dc_init(elem,hybrid,hvcoord,nets,nete)
...
subroutine rb_init(elem,hybrid,hvcoord,nets,nete)
...
subroutine bi_init(elem,hybrid,hvcoord,nets,nete)
