...
! Along with all the other things that are test case specific (rearth/Omega scaling for small-earth experiments, etc.)
    ...
    if (test_case == "dbvor") then
      Lx = 5000.0D0 * 1000.0D0
      Ly = 5000.0D0 * 1000.0D0
      Sx = 0.0D0
      Sy = 0.0D0
    else if (test_case == "hgw") then
       Lx = 6000.0D0 * 1000.0D0
       Ly = 6000.0D0 * 1000.0D0
       Sx = -3000.0D0 * 1000.0D0
       Sy = -3000.0D0 * 1000.0D0
    else if (test_case == "nhgw") then
       Lx = 300.0D0 * 1000.0D0
       Ly = 300.0D0 * 1000.0D0
       Sx = -150.0D0 * 1000.0D0
       Sy = -150.0D0 * 1000.0D0
    else if (test_case == "hmw") then
       Lx = 240.0D0 * 1000.0D0
       Ly = 240.0D0 * 1000.0D0
       Sx = 0.0D0 * 1000.0D0
       Sy = 0.0D0 * 1000.0D0
    else if (test_case == "nhmw") then
       Lx = 144.0D0 * 1000.0D0
       Ly = 144.0D0 * 1000.0D0
       Sx = 0.0D0 * 1000.0D0
       Sy = 0.0D0 * 1000.0D0
    else if (test_case == "smw") then
       Lx = 100.0D0 * 1000.0D0
       Ly = 100.0D0 * 1000.0D0
       Sx = 0.0D0 * 1000.0D0
       Sy = 0.0D0 * 1000.0D0
    else if (test_case == "dc" .OR. test_case == "mdc") then
       Lx = 51.2D0 * 1000.0D0
       Ly = 51.2D0 * 1000.0D0
       Sx = -25.6D0 * 1000.0D0
       Sy = -25.6D0 * 1000.0D0
    else if (test_case == "rb" .OR. test_case == "mrb") then
       Lx = 1.0D0 * 1000.0D0
       Ly = 1.0D0 * 1000.0D0
       Sx = 0.0D0
       Sy = 0.0D0
! THESE ARE WRONG AND NEED TO BE FIXED...
    else if (test_case == "bi" .OR. test_case == "mbi") then
       Lx = 5000.0D0 * 1000.0D0
       Ly = 5000.0D0 * 1000.0D0
       Sx = 0.0D0
       Sy = 0.0D0
    else if (test_case == "tc") then
       Lx = 5000.0D0 * 1000.0D0
       Ly = 5000.0D0 * 1000.0D0
       Sx = 0.0D0
       Sy = 0.0D0
    else if (test_case == "sc") then
       Lx = 5000.0D0 * 1000.0D0
       Ly = 5000.0D0 * 1000.0D0
       Sx = 0.0D0
       Sy = 0.0D0
