...
DS_new = xr.open_dataset('run-new-' + sys.argv[1] + '/swtc21.nc')
DS_orig = xr.open_dataset('run-orig-' + sys.argv[1] + '/swtc21.nc')
...
plot_3Dvar(geop_new, geop_orig, 'geop0', 0, 0)
plot_3Dvar(u_new, u_orig, 'u0', 0, 0)
plot_3Dvar(v_new, v_orig, 'v0', 0, 0)
