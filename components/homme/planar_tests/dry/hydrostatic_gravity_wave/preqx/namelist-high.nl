...
&ctl_nl
  ...
  test_case         = "hgw"         		! test identifier
  transport_alg     = 0            
  theta_advect_form = 1
  vert_remap_q_alg  = 10
  moisture          = 'dry'
  ne_x              = 200                       ! number of elements in x-dir
  ne_y              = 200                       ! number of elements in y-dir
  qsize             = 0                         ! num tracer fields
  nmax              = 4000                      ! total number of steps: 60000s / tstep
  statefreq         = 400                       ! number of steps between screen dumps
