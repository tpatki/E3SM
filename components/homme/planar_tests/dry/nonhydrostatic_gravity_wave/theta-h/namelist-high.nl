...
&ctl_nl
  ...
  test_case         = "nhgw"         		! test identifier
  theta_hydrostatic_mode = .true.
  transport_alg     = 0            
  theta_advect_form = 1
  vert_remap_q_alg  = 10
  moisture          = 'dry'
  ne_x              = 100                       ! number of elements in x-dir
  ne_y              = 100                       ! number of elements in y-dir
  qsize             = 0                         ! num tracer fields
  nmax              = 2400                      ! total number of steps: 3600s / tstep
